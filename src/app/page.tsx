    ...
    <>
      ...
      <section className="relative overflow-hidden bg-blits-black text-white">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-4 py-16 lg:grid-cols-2 lg:py-24">
          ...
          {/* Dubbele-roete kaarte — slegs op groter skerms */}
      ...
      <section className="mx-auto max-w-7xl px-4 py-10 sm:py-14">
        <div className="mb-6 flex items-end justify-between">
          <div>
            <h2 className="heading-block text-2xl text-blits-black sm:text-3xl">Koop per kategorie</h2>
            <p className="mt-1 text-sm text-blits-grey sm:text-base">Alles vir die huis, terrein en projek.</p>
          </div>
      ...
      <section className="bg-white py-10 sm:py-14">
        <div className="mx-auto max-w-7xl px-4">
          <div className="mb-6 text-center">
            <h2 className="heading-block text-2xl text-blits-black sm:text-3xl">Meer as net &apos;n winkel</h2>
            <p className="mt-1 text-sm text-blits-grey sm:text-base">Kerndienste wat ons gemeenskap al dekades lank vertrou.</p>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-10 sm:py-14">
        <div className="mb-6 flex items-end justify-between">
          <h2 className="heading-block text-2xl text-blits-black sm:text-3xl">Topverkopers</h2>
